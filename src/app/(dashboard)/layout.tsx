...
export default function DashboardLayout({
  ...
  return (
    <>
      <AppSidebar />
      <SidebarInset>
        <header className="flex border-2  h-16 shrink-0 justify-between pr-5 items-center gap-2 transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12">
